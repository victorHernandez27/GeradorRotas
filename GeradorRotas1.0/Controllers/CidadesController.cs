...
namespace GeradorRotas.Controllers
{
    public class CidadesController : Controller
    {
        ...
        public CidadesController(GeradorRotasContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        public async Task<IActionResult> Create([Bind("Id,CidadeNome,Estado")] Cidade cidade)
        {
        ...
        // For more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CidadeNome,Estado")] Cidade cidade)
        {
            if (id != cidade.Id)
            {
                return NotFound();
